...
class FALocation(object):
    ...
    def __hash__(self):
        return hash(("FALOCATION", self.name, self.init, self.accept))
...
class FATran(object):
    def __init__(self, id, source="", target="", resettimedword=None):
        ...
        self.source = source
        self.target = target
        self.resettimedword = resettimedword
...
class FA:
    ...
    def show(self):
        ...
        for t in self.trans:
            print(t.id, t.source, t.target, t.resettimedword)
